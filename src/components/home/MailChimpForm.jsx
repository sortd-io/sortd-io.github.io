...
class MailChimpForm extends React.Component {
  ...
  render () {
    ...
    const url = "https://rockt.us17.list-manage.com/subscribe/post?u=f11728abdca6d9c4e72f748bf&amp;id=3e22517e03";
    const { form } = this.props;
    ...
    return (
        ...
        render={({ subscribe, status, message }) => (
          ...
          <CustomizedForm {...fields} submitting={status === "sending"} onChange={this.handleFormChange} onSubmit={(props) => subscribe({...props})}/>
          }
            {status === "error" && 
            <Result
                status="error"
